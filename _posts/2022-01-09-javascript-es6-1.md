...
🙋‍♀️ : const a가 이렇게 끌어올려지면서, var로 선언했을 때처럼 **a에는 `undefined가 할당`되어서** a는 undefined가 찍히지 않을까?
...
=> <strong style="color:black;background-color:yellow">a는 타입 에러가 난다</strong><br/>
(3-3.에서 코드 설명)
